	...
	<!-- Header -->
				<header id="header">
					<div class="logo container">
						<div>							
							<p><font color="dimgray">공지사항</font></p>
						</div>
					</div>
				</header>
		...
		<!-- Nav -->
				<nav id="nav">
					<ul>
						...
						<li><a href="<%=path%>/notice.nanum">공지사항</a>						
						</li>						
						<li>
							<a href="<%=path %>/board_list.nanum">배달나눔</a>
						</li>
						<li>
						<a href="<%=path %>/main/FoodRecommendationPage2.jsp">메뉴 추천</a>
						</li>
						<li>
							<a href="<%=path%>/main/event.jsp">이벤트</a>
								</li>
...
<div class="col-sm-8">
	...
	<c:url var="path" value="/board_write_notice.nanum">		
	</c:url>
