...
$(function(){
	...
	$(".click-table > tbody > tr").click(function(){
		...
		<c:url var="path" value="/board_detail_ulsan.nanum">
		...
		alert("로그인 해주세요");
			...
			var theURL = path + "/board_list_ulsan.nanum";						
...
<a class="kboard-branch-button" href="<%=path%>/board_list_seoul.nanum" title="서울">서울</a>
				...
				<a class="kboard-branch-button active" href="<%=path%>/board_list_ulsan.nanum" title="울산">울산</a>
	...
	<table class="table table-hover click-table">
		<thead>
		<caption align="right">울산 게시판</caption>
			<tr>
	...
	<c:url var="path" value="/board_write_ulsan.nanum">		
	</c:url>
	...
	<div style="text-align:center">
		<ul class="pagination">
			<c:url var="path" value="/board_list_ulsan.nanum">
