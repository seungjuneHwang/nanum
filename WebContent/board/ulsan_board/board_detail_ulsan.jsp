...
<script>
	function add_reply(){
		...
		// 접속할 주소
		<c:url var="path1" value="/add_reply_ulsan.nanum"/>
		<c:url var="path2" value="/board_detail_ulsan.nanum">
			<c:param name="page" value="${param.page}"/>
	...
	function remove_reply(reply_idx){
		...
		// 요청할 주소
		<c:url var="path1" value="/remove_reply_ulsan.nanum"/>
		<c:url var="path2" value="/board_detail_ulsan.nanum">
			<c:param name="page" value="${param.page}"/>
			<c:param name="board_idx" value="${param.board_idx}"/>
		</c:url>
	...
	<form class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
				...
				<c:url var="path" value="/modify_board_ulsan.nanum">
					<c:param name="page" value="${param.page }"/>
					<c:param name="board_idx" value="${param.board_idx }"/>
				</c:url>				
				...
				<c:url var="path" value="/delete_board_ulsan.nanum">
