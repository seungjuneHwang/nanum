...
<a class="kboard-branch-button" href="<%=path%>/board_list_seoul.nanum" title="서울">서울</a>
				...
				<a class="kboard-branch-button" href="<%=path%>/board_list_daejeon.nanum" title="경상남도">경상남도</a>
				<a class="kboard-branch-button" href="<%=path%>/board_list_gyeongnam.nanum" title="경상북도">경상북도</a>
