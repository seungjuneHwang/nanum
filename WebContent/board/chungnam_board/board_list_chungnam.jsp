...
$(function(){
	...
	$(".click-table > tbody > tr").click(function(){
		...
		<c:url var="path" value="/board_detail_chungnam.nanum">
		...
		alert("로그인 해주세요");
			...
			var theURL = path + "/board_list_chungnam.nanum";						
...
<div class="col-sm-8">
	...
	<a class="kboard-branch-button" href="<%=path%>/board_list_seoul.nanum" title="서울">서울</a>
				...
				<a class="kboard-branch-button active" href="<%=path%>/board_list_chungnam.nanum" title="충청남도">충청남도</a>
	...
	<table class="table table-hover click-table">
		<thead>
		<caption align="right">충청남도 게시판</caption>
			<tr>
	...
	<c:url var="path" value="/board_write_chungnam.nanum">		
	</c:url>
	...
	<div style="text-align:center">
		<ul class="pagination">
			<c:url var="path" value="/board_list_chungnam.nanum">
