...
$(function(){
	...
	$(".click-table > tbody > tr").click(function(){
		...
		<c:url var="path" value="/board_detail_daegu.nanum">
		...
		alert("로그인 해주세요");
			...
			var theURL = path + "/board_list_daegu.nanum";						
			...
			function closeSignUpWindow(){	
				var path = getContextPath();						
				var theURL = path + "/signUp_daegu.nanum";						
				// 호출 한 부모 페이지에서 URL 호출						
				opener.window.location = theURL;						
				// 호출 한 뒤 현재 팝업 창 닫기 이벤트						
				close();						
...
<div class="col-sm-8">
	...
	<div class="map-area" style="left:8%;top:13%;" data-map="https://www.cosmosfarm.com/demo/wp-content/plugins/kboard/skin/ocean-franchise/images/map-v2-incheon.png"><a href="<%=path%>/board_list_incheon.nanum">인천</a></div>
			...
			<div class="map-area" style="left:10%;top:92%;" data-map="https://www.cosmosfarm.com/demo/wp-content/plugins/kboard/skin/ocean-franchise/images/map-v2-jeju.png"><a href="<%=path%>/board_list_jejuIsland.nanum">제주도</a></div>		
			</div>
		...
		<form id="kboard-search-form" method="get" action="/demo/kboard-ocean-franchise-skin/?mod=list&pageid=1">
			...
			<div class="kboard-branch">
				...
				<a class="kboard-branch-button active" href="<%=path%>/board_list_daegu.nanum" title="대구">대구</a>
				...
				<a class="kboard-branch-button" href="<%=path%>/board_list_gyeongnam.nanum" title="경상남도">경상남도</a>
	...
	<table class="table table-hover click-table">
		<thead>
		<caption align="right">대구 게시판</caption>
			<tr>
	...
	<c:url var="path" value="/board_write_daegu.nanum">		
	</c:url>
	...
	<div style="text-align:center">
		<ul class="pagination">
			<c:url var="path" value="/board_list_daegu.nanum">
