...
<div class="col-sm-8">
	...
	<div class="kboard-header">
		<div class="kboard-map-v2">
			...
			<div class="map-area" style="left:8%;top:13%;" data-map="https://www.cosmosfarm.com/demo/wp-content/plugins/kboard/skin/ocean-franchise/images/map-v2-incheon.png"><a href="#">인천</a></div>
			<div class="map-area" style="left:20%;top:16%;" data-map="https://www.cosmosfarm.com/demo/wp-content/plugins/kboard/skin/ocean-franchise/images/map-v2-seoul.png"><a href="#">서울</a></div>
			<div class="map-area" style="left:20%;top:23%;" data-map="https://www.cosmosfarm.com/demo/wp-content/plugins/kboard/skin/ocean-franchise/images/map-v2-gyeonggi.png"><a href="#">경기도</a></div>
			<div class="map-area" style="left:44%;top:14%;" data-map="https://www.cosmosfarm.com/demo/wp-content/plugins/kboard/skin/ocean-franchise/images/map-v2-gangwon.png"><a href="#">강원도</a></div>
			<div class="map-area" style="left:32%;top:28%;" data-map="https://www.cosmosfarm.com/demo/wp-content/plugins/kboard/skin/ocean-franchise/images/map-v2-chungbuk.png"><a href="#">충청북도</a></div>
			<div class="map-area" style="left:2%;top:35%;" data-map="https://www.cosmosfarm.com/demo/wp-content/plugins/kboard/skin/ocean-franchise/images/map-v2-chungnam.png"><a href="#">충청남도</a></div>
			<div class="map-area" style="left:22%;top:33%;" data-map="https://www.cosmosfarm.com/demo/wp-content/plugins/kboard/skin/ocean-franchise/images/map-v2-sejong.png"><a href="#">세종</a></div>
			<div class="map-area" style="left:22%;top:40%;" data-map="https://www.cosmosfarm.com/demo/wp-content/plugins/kboard/skin/ocean-franchise/images/map-v2-daejeon.png"><a href="#">대전</a></div>
			<div class="map-area" style="left:50%;top:40%;" data-map="https://www.cosmosfarm.com/demo/wp-content/plugins/kboard/skin/ocean-franchise/images/map-v2-gyeongbuk.png"><a href="#">경상북도</a></div>
			<div class="map-area" style="left:16%;top:54%;" data-map="https://www.cosmosfarm.com/demo/wp-content/plugins/kboard/skin/ocean-franchise/images/map-v2-jeollabuk.png"><a href="#">전라북도</a></div>
			<div class="map-area" style="left:48%;top:52%;" data-map="https://www.cosmosfarm.com/demo/wp-content/plugins/kboard/skin/ocean-franchise/images/map-v2-daegu.png"><a href="#">대구</a></div>
			<div class="map-area" style="left:67%;top:57%;" data-map="https://www.cosmosfarm.com/demo/wp-content/plugins/kboard/skin/ocean-franchise/images/map-v2-ulsan.png"><a href="#">울산</a></div>
			<div class="map-area" style="left:41%;top:60%;" data-map="https://www.cosmosfarm.com/demo/wp-content/plugins/kboard/skin/ocean-franchise/images/map-v2-gyeongnam.png"><a href="#">경상남도</a></div>
			<div class="map-area" style="left:10%;top:73%;" data-map="https://www.cosmosfarm.com/demo/wp-content/plugins/kboard/skin/ocean-franchise/images/map-v2-jeollanam.png"><a href="#">전라남도</a></div>
			<div class="map-area" style="left:16%;top:66%;" data-map="https://www.cosmosfarm.com/demo/wp-content/plugins/kboard/skin/ocean-franchise/images/map-v2-gwangju.png"><a href="#">광주</a></div>
			<div class="map-area" style="left:64%;top:64%;" data-map="https://www.cosmosfarm.com/demo/wp-content/plugins/kboard/skin/ocean-franchise/images/map-v2-busan.png"><a href="#">부산</a></div>
			<div class="map-area" style="left:10%;top:92%;" data-map="https://www.cosmosfarm.com/demo/wp-content/plugins/kboard/skin/ocean-franchise/images/map-v2-jeju.png"><a href="#">제주도</a></div>
		</div>
		...
		<form id="kboard-search-form" method="get" action="/demo/kboard-ocean-franchise-skin/?mod=list&pageid=1">
			...
			<div class="kboard-branch">
				...
				<a class="kboard-branch-button active" href="#" title="전체">전체</a>
				<a class="kboard-branch-button" href="#" title="서울">서울</a>
				<a class="kboard-branch-button" href="#" title="부산">부산</a>
				<a class="kboard-branch-button" href="#" title="대구">대구</a>
				<a class="kboard-branch-button" href="#" title="인천">인천</a>
				<a class="kboard-branch-button" href="#" title="광주">광주</a>
				<a class="kboard-branch-button" href="#" title="대전">대전</a>
				<a class="kboard-branch-button" href="#" title="울산">울산</a>
				<a class="kboard-branch-button" href="#" title="세종">세종</a>
				<a class="kboard-branch-button" href="#" title="경기도">경기도</a>
				<a class="kboard-branch-button" href="#" title="경상남도">경상남도</a>
				<a class="kboard-branch-button" href="#" title="경상북도">경상북도</a>
				<a class="kboard-branch-button" href="#" title="전라남도">전라남도</a>
				<a class="kboard-branch-button" href="#" title="전라북도">전라북도</a>
				<a class="kboard-branch-button" href="#" title="충청남도">충청남도</a>
				<a class="kboard-branch-button" href="#" title="충청북도">충청북도</a>
				<a class="kboard-branch-button" href="#" title="강원도">강원도</a>
				<a class="kboard-branch-button" href="#" title="제주도">제주도</a>
			</div>
		</form>
	</div>
	</div>
