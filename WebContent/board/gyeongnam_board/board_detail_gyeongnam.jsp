...
<script>
	alert('삭제된 글입니다');
	<c:url var="path" value="/board_list_gyeongnam.nanum">
...
<script>
	function add_reply(){
		...
		// 접속할 주소
		<c:url var="path1" value="/add_reply_gyeongnam.nanum"/>
		<c:url var="path2" value="/board_detail_gyeongnam.nanum">
			<c:param name="page" value="${param.page}"/>
	...
	function remove_reply(reply_idx){
		...
		// 요청할 주소
		<c:url var="path1" value="/remove_reply_gyeongnam.nanum"/>
		<c:url var="path2" value="/board_detail_gyeongnam.nanum">
			<c:param name="page" value="${param.page}"/>
			<c:param name="board_idx" value="${param.board_idx}"/>
		</c:url>
	...
	<form class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
				...
				<c:url var="path" value="/modify_board_gyeongnam.nanum">
					<c:param name="page" value="${param.page }"/>
					<c:param name="board_idx" value="${param.board_idx }"/>
				</c:url>				
				...
				<c:url var="path" value="/delete_board_gyeongnam.nanum">
