...
$(function(){
	...
	$(".click-table > tbody > tr").click(function(){
		...
		<c:url var="path" value="/board_detail_gyeongnam.nanum">
		...
		alert("로그인 해주세요");
			...
			var theURL = path + "/board_list_gyeongnam.nanum";						
...
<a class="kboard-branch-button" href="<%=path%>/board_list_seoul.nanum" title="서울">서울</a>
	...
	<table class="table table-hover click-table">
		<thead>
		<caption align="right">경상남도 게시판</caption>
			<tr>
	...
	<c:url var="path" value="/board_write_gyeongnam.nanum">		
	</c:url>
