		    ...
		    <article class="half">
			        ...
			        <div class="content">
				            <div class="signin-cont cont">
					                <form action="<%=path%>/login_proc.nanum" method="post"">
						                    ...
						                    <div class="submit-wrap">						                    					                    
							                        ...
							                        <a href="<%=path%>/signUp.nanum" class="more" onclick="closeSignUpWindow()">회원가입</a>
							                        <a href="#" class="more">비밀번호를 잊으셨습니까?</a>
						                    </div>
        					        </form>
    				        </div>       					        
            		</div>			    
