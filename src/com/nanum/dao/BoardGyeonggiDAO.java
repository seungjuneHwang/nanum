...
public class BoardGyeonggiDAO {
	...
	public static int addBoardContent(BoardBean bean) throws Exception {
		...
		sql.append("insert into BOARD_TABLE_gyeonggi ");
		...
		// 시퀀스의 현재 값을 가져온다.
		String sql3 = "select max(board_idx) as a from board_table_gyeonggi";
	...
	public static BoardBean getBoardContent(int board_idx) throws Exception {
		...
		sql.append("from BOARD_TABLE_gyeonggi a1, USER a2 ");
	...
	public static ArrayList<BoardBean> getBoardList(int page) throws Exception {
		...
		String sql2 = "SELECT a.board_idx, a.board_subject,  a.board_read_cnt "
				...
				+ ",(SELECT COUNT(*) FROM reply_table_gyeonggi c WHERE c.reply_board_idx=a.board_idx) reply_cnt  "
				+ "FROM board_table_gyeonggi a WHERE a.board_status = 1 ORDER BY a.board_idx desc limit ?, ?";
	...
	public static int getPageCnt() throws Exception {
		...
		// 쿼리문
		StringBuffer sql = new StringBuffer();
		sql.append("select count(*) from board_table_gyeonggi where board_status=1 ");
	...
	public static void deleteBoard(int board_idx) throws Exception {
		...
		// 쿼리문
		StringBuffer sql = new StringBuffer();
		sql.append("update board_table_gyeonggi ");
	...
	public static void modifyBoard(BoardBean bean) throws Exception {
		...
		// 쿼리문
		StringBuffer sql = new StringBuffer();
		sql.append("update board_table_gyeonggi set ");
	...
	public static void add_reply(ReplyBean bean) throws Exception {
		...
		StringBuffer sql = new StringBuffer();
		sql.append("insert into reply_table_gyeonggi ");
	...
	public static ArrayList<ReplyBean> getReplyList(int board_idx) throws Exception {
		...
		sql.append("from reply_table_gyeonggi a1, user a2 ");
	...
	public static void remove_reply(int reply_idx) throws Exception {
		...
		StringBuffer sql = new StringBuffer();
		sql.append("update reply_table_gyeonggi ");
