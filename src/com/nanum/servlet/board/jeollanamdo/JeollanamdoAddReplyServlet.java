 ...
 */
@WebServlet("/JeollanamdoAddReplyServlet")
public class JeollanamdoAddReplyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public JeollanamdoAddReplyServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			BoardJeollanamdoDAO.add_reply(bean);
			
			String site = "/board/jeollanamdo_board/add_reply_jeollanamdo.jsp";
