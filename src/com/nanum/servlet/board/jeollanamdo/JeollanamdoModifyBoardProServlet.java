 ...
 */
@WebServlet("/JeollanamdoModifyBoardProServlet")
public class JeollanamdoModifyBoardProServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public JeollanamdoModifyBoardProServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			// 수정한다.
			BoardJeollanamdoDAO.modifyBoard(board_bean);
			// 뷰로 이동한다.
			String site = "/board/jeollanamdo_board/modify_board_pro_jeollanamdo.jsp";
