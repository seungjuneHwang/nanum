 ...
 */
@WebServlet("/GyeongbukModifyBoardProServlet")
public class GyeongbukModifyBoardProServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GyeongbukModifyBoardProServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			// 수정한다.
			BoardGyeongbukDAO.modifyBoard(board_bean);
			// 뷰로 이동한다.
			String site = "/board/gyeongbuk_board/modify_board_pro_gyeongbuk.jsp";
