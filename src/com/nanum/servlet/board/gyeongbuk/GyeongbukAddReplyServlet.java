 ...
 */
@WebServlet("/GyeongbukAddReplyServlet")
public class GyeongbukAddReplyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GyeongbukAddReplyServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			BoardGyeongbukDAO.add_reply(bean);
			
			String site = "/board/gyeongbuk_board/add_reply_gyeongbuk.jsp";
