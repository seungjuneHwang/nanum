 ...
 */
@WebServlet("/GyeongbukBoardWriteProServlet")
public class GyeongbukBoardWriteProServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GyeongbukBoardWriteProServlet() {
        super();
...
//			board_bean.setBoard_info_idx(board_info_idx);
			...
			int board_idx = BoardGyeongbukDAO.addBoardContent(board_bean);
			System.out.println(board_idx);
			request.setAttribute("board_idx", board_idx);
			// 뷰로 이동한다.
			String site = "/board/gyeongbuk_board/board_write_gyeongbuk.jsp";
