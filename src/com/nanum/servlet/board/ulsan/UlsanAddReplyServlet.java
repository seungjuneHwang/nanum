 ...
 */
@WebServlet("/UlsanAddReplyServlet")
public class UlsanAddReplyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UlsanAddReplyServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			BoardUlsanDAO.add_reply(bean);
			
			String site = "/board/ulsan_board/add_reply_ulsan.jsp";
