 ...
 */
@WebServlet("/IncheonAddReplyServlet")
public class IncheonAddReplyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public IncheonAddReplyServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			BoardIncheonDAO.add_reply(bean);
			
			String site = "/board/incheon_board/add_reply_incheon.jsp";
