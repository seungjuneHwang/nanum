 ...
 */
@WebServlet("/IncheonBoardWriteProServlet")
public class IncheonBoardWriteProServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public IncheonBoardWriteProServlet() {
        super();
...
//			board_bean.setBoard_info_idx(board_info_idx);
			...
			int board_idx = BoardIncheonDAO.addBoardContent(board_bean);
			System.out.println(board_idx);
			request.setAttribute("board_idx", board_idx);
			// 뷰로 이동한다.
			String site = "/board/incheon_board/board_write_pro_incheon.jsp";
