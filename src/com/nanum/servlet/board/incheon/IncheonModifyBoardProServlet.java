 ...
 */
@WebServlet("/IncheonModifyBoardProServlet")
public class IncheonModifyBoardProServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public IncheonModifyBoardProServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			// 수정한다.
			BoardIncheonDAO.modifyBoard(board_bean);
			// 뷰로 이동한다.
			String site = "/board/incheon_board/modify_board_pro_incheon.jsp";
