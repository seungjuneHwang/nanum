 ...
 */
@WebServlet("/JyeonBukAddReplyServlet")
public class JyeonBukAddReplyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public JyeonBukAddReplyServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			BoardJyeonBukDAO2.add_reply(bean);
			
			String site = "/board/jyeonbuk_board/add_reply_jyeonbuk.jsp";
