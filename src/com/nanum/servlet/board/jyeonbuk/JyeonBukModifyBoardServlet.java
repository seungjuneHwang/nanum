 ...
 */
@WebServlet("/JyeonBukModifyBoardServlet")
public class JyeonBukModifyBoardServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public JyeonBukModifyBoardServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			// 뷰로 이동한다.
			String site = "/board/jyeonbuk_board/modify_board_jyeonbuk.jsp";
