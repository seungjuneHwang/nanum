 ...
 */
@WebServlet("/JyeonBukModifyBoardProServlet")
public class JyeonBukModifyBoardProServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public JyeonBukModifyBoardProServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			// 수정한다.
			BoardJyeonBukDAO2.modifyBoard(board_bean);
			// 뷰로 이동한다.
			String site = "/board/jyeonbuk_board/modify_board_pro_jyeonbuk.jsp";
