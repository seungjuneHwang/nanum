 ...
 */
@WebServlet("/GwangjuModifyBoardProServlet")
public class GwangjuModifyBoardProServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GwangjuModifyBoardProServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			// 수정한다.
			BoardGwangjuDAO.modifyBoard(board_bean);
			// 뷰로 이동한다.
			String site = "/board/gwangju_board/modify_board_pro_gwangju.jsp";
