 ...
 */
@WebServlet("/GwangjuModifyBoardServlet")
public class GwangjuModifyBoardServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GwangjuModifyBoardServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			// 뷰로 이동한다.
			String site = "/board/gwangju_board/modify_board_gwangju.jsp";
