 ...
 */
@WebServlet("/GwangjuAddReplyServlet")
public class GwangjuAddReplyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GwangjuAddReplyServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			BoardGwangjuDAO.add_reply(bean);
			
			String site = "/board/gwangju_board/add_reply_gwangju.jsp";
