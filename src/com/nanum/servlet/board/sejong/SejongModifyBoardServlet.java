 ...
 */
@WebServlet("/SejongModifyBoardServlet")
public class SejongModifyBoardServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SejongModifyBoardServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			// 뷰로 이동한다.
			String site = "/board/sejong_board/modify_board_sejong.jsp";
