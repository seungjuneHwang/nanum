 ...
 */
@WebServlet("/SejongAddReplyServlet")
public class SejongAddReplyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SejongAddReplyServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			BoardSejongDAO.add_reply(bean);
			
			String site = "/board/sejong_board/add_reply_sejong.jsp";
