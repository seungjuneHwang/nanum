 ...
 */
@WebServlet("/SejongModifyBoardProServlet")
public class SejongModifyBoardProServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SejongModifyBoardProServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			// 수정한다.
			BoardSejongDAO.modifyBoard(board_bean);
			// 뷰로 이동한다.
			String site = "/board/sejong_board/modify_board_pro_sejong.jsp";
