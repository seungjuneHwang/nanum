 ...
 */
@WebServlet("/DaejeonAddReplyServlet")
public class DaejeonAddReplyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DaejeonAddReplyServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			BoardDaejeonDAO.add_reply(bean);
			
			String site = "/board/daejeon_board/add_reply_daejeon.jsp";
