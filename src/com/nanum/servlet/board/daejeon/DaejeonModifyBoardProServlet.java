 ...
 */
@WebServlet("/DaejeonModifyBoardProServlet")
public class DaejeonModifyBoardProServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DaejeonModifyBoardProServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			// 수정한다.
			BoardDaejeonDAO.modifyBoard(board_bean);
			// 뷰로 이동한다.
			String site = "/board/daejeon_board/modify_board_pro_daejeon.jsp";
