 ...
 */
@WebServlet("/ChungNamAddReplyServlet")
public class ChungNamAddReplyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ChungNamAddReplyServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			BoardChungNamDAO.add_reply(bean);
			
			String site = "/board/chungnam_board/add_reply_chungnam.jsp";
