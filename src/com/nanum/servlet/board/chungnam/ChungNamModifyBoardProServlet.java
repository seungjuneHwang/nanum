 ...
 */
@WebServlet("/ChungNamModifyBoardProServlet")
public class ChungNamModifyBoardProServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ChungNamModifyBoardProServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			// 수정한다.
			BoardChungNamDAO.modifyBoard(board_bean);
			// 뷰로 이동한다.
			String site = "/board/chungnam_board/modify_board_pro_chungnam.jsp";
