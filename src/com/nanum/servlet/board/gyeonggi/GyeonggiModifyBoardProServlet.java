 ...
 */
@WebServlet("/GyeonggiModifyBoardProServlet")
public class GyeonggiModifyBoardProServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GyeonggiModifyBoardProServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			// 수정한다.
			BoardGyeonggiDAO.modifyBoard(board_bean);
			// 뷰로 이동한다.
			String site = "/board/gyeonggi_board/modify_board_pro_gyeonggi.jsp";
