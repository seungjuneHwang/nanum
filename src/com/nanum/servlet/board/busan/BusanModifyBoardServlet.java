 ...
 */
@WebServlet("/BusanModifyBoardServlet")
public class BusanModifyBoardServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BusanModifyBoardServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			// 뷰로 이동한다.
			String site = "/board/busan_board/modify_board_busan.jsp";
