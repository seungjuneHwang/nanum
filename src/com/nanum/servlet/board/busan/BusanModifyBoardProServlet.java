 ...
 */
@WebServlet("/BusanModifyBoardProServlet")
public class BusanModifyBoardProServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BusanModifyBoardProServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			// 수정한다.
			BoardBusanDAO.modifyBoard(board_bean);
			// 뷰로 이동한다.
			String site = "/board/busan_board/modify_board_pro_busan.jsp";
