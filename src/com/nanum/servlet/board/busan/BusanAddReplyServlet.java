 ...
 */
@WebServlet("/BusanAddReplyServlet")
public class BusanAddReplyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BusanAddReplyServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			BoardBusanDAO.add_reply(bean);
			
			String site = "/board/busan_board/add_reply_busan.jsp";
