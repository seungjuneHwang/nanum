 ...
 */
@WebServlet("/JejuIslandModifyBoardProServlet")
public class JejuIslandModifyBoardProServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public JejuIslandModifyBoardProServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			// 수정한다.
			BoardJejuIslandDAO.modifyBoard(board_bean);
			// 뷰로 이동한다.
			String site = "/board/jejuIsland_board/modify_board_pro_jejuIsland.jsp";
