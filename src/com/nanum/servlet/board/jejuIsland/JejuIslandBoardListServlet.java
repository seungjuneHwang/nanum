 ...
 */
@WebServlet("/JejuIslandBoardListServlet")
public class JejuIslandBoardListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public JejuIslandBoardListServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			// 전체 페이지수를 구한다.
			int page_cnt = BoardJejuIslandDAO.getPageCnt();
			...
			// 게시판 글 리스트를 가져온다.
			ArrayList<BoardBean> board_list = BoardJejuIslandDAO.getBoardList(page);
			request.setAttribute("board_list", board_list);

			String site = "/board/jejuIsland_board/board_list_jejuIsland.jsp";
