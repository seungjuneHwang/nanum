 ...
 */
@WebServlet("/JejuIslandAddReplyServlet")
public class JejuIslandAddReplyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public JejuIslandAddReplyServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			BoardJejuIslandDAO.add_reply(bean);
			
			String site = "/board/jejuIsland_board/add_reply_jejuIsland.jsp";
