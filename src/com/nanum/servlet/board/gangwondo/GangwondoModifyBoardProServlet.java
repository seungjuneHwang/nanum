 ...
 */
@WebServlet("/GangwondoModifyBoardProServlet")
public class GangwondoModifyBoardProServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GangwondoModifyBoardProServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			// 수정한다.
			BoardGangwondoDAO.modifyBoard(board_bean);
			// 뷰로 이동한다.
			String site = "/board/gangwondo_board/modify_board_pro_gangwondo.jsp";
