 ...
 */
@WebServlet("/GyeongnamModifyBoardProServlet")
public class GyeongnamModifyBoardProServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GyeongnamModifyBoardProServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			// 수정한다.
			BoardGyeongnamDAO.modifyBoard(board_bean);
			// 뷰로 이동한다.
			String site = "/board/gyeongnam_board/modify_board_pro_gyeongnam.jsp";
