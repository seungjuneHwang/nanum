 ...
 */
@WebServlet("/GyeongnamBoardListServlet")
public class GyeongnamBoardListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public GyeongnamBoardListServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			// 전체 페이지수를 구한다.
			int page_cnt = BoardGyeongnamDAO.getPageCnt();
			...
			// 게시판 글 리스트를 가져온다.
			ArrayList<BoardBean> board_list = BoardGyeongnamDAO.getBoardList(page);
			request.setAttribute("board_list", board_list);

			String site = "/board/gyeongnam_board/board_list_gyeongnam.jsp";
