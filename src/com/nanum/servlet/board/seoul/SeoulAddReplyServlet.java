 ...
 */
@WebServlet("/SeoulAddReplyServlet")
public class SeoulAddReplyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SeoulAddReplyServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			BoardSeoulDAO.add_reply(bean);
			
			String site = "/board/seoul_board/add_reply_seoul.jsp";
