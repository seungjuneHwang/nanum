 ...
 */
@WebServlet("/SeoulModifyBoardProServlet")
public class SeoulModifyBoardProServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SeoulModifyBoardProServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			// 수정한다.
			BoardSeoulDAO.modifyBoard(board_bean);
			// 뷰로 이동한다.
			String site = "/board/seoul_board/modify_board_pro_seoul.jsp";
