 ...
 */
@WebServlet("/DaeguModifyBoardProServlet")
public class DaeguModifyBoardProServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DaeguModifyBoardProServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			// 수정한다.
			BoardDaeguDAO.modifyBoard(board_bean);
			// 뷰로 이동한다.
			String site = "/board/daegu_board/modify_board_pro_daegu.jsp";
