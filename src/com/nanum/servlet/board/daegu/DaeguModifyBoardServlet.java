 ...
 */
@WebServlet("/DaeguModifyBoardServlet")
public class DaeguModifyBoardServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DaeguModifyBoardServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			// 뷰로 이동한다.
			String site = "/board/daegu_board/modify_board_daegu.jsp";
