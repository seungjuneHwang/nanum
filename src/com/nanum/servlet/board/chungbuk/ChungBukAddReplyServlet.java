 ...
 */
@WebServlet("/ChungBukAddReplyServlet")
public class ChungBukAddReplyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ChungBukAddReplyServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			BoardChungBukDAO.add_reply(bean);
			
			String site = "/board/chungbuk_board/add_reply_chungbuk.jsp";
