 ...
 */
@WebServlet("/ChungBukModifyBoardProServlet")
public class ChungBukModifyBoardProServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ChungBukModifyBoardProServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			// 수정한다.
			BoardChungBukDAO.modifyBoard(board_bean);
			// 뷰로 이동한다.
			String site = "/board/chungbuk_board/modify_board_pro_chungbuk.jsp";
