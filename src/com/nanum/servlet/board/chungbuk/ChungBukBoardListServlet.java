 ...
 */
@WebServlet("/ChungBukBoardListServlet")
public class ChungBukBoardListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ChungBukBoardListServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			// 전체 페이지수를 구한다.
			int page_cnt = BoardChungBukDAO.getPageCnt();
			...
			// 게시판 글 리스트를 가져온다.
			ArrayList<BoardBean> board_list = BoardChungBukDAO.getBoardList(page);
			request.setAttribute("board_list", board_list);

			String site = "/board/chungbuk_board/board_list_chungbuk.jsp";
